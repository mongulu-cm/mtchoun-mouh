...
stopWords = ["Phone", "Cours Pierre", "Tel.", "www.consulacam-marseille.fr", "REPUBLIQUE", "Paix", "Marseille",
             "Cameroun",
             "passeports", "presentation", "REPUBLIC", "Cameroon", "Peace", "CCM", "COMMUNIQUE", "DU", "OF", "N°",
             "2020",
